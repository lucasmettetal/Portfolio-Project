  ...
  await prisma.product.createMany({
    data: [
      // Chemises
      {
        ...
        price: 89.00,
        imageUrl: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&h=800&fit=crop&auto=format',
      ...
      },
      {
        ...
        price: 135.00,
        imageUrl: 'https://images.unsplash.com/photo-1521577352947-9bb58764b69a?w=600&h=800&fit=crop&auto=format',
      ...
      },
      {
        ...
        price: 118.00,
        imageUrl: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?w=600&h=800&fit=crop&auto=format',
        inStock: true, quantity: 9, sizes: ['XS','S','M','L','XL'], materials: ['Lin lavé 100%'], categoryId: robes.id,
      },
      {
      ...
      // Vestes
      {
        ...
        inStock: true, quantity: 6, sizes: ['XS','S','M','L','XL'], materials: ['Laine mérinos 100%', 'Doublure coton'], categoryId: vestes.id,
      },
      {
        ...
        price: 245.00,
        imageUrl: 'https://images.unsplash.com/photo-1544022613-e87ca75a784a?w=600&h=800&fit=crop&auto=format',
        inStock: true, quantity: 5, sizes: ['S','M','L','XL'], materials: ['Laine tweed 90%', 'Cachemire 10%'], categoryId: vestes.id,
      },
      {
        ...
        inStock: true, quantity: 4, sizes: ['XS','S','M','L'], materials: ['Cachemire 100%'], categoryId: vestes.id,
      },
      {
        ...
        inStock: true, quantity: 8, sizes: ['XS','S','M','L','XL'], materials: ['Lin 100%'], categoryId: vestes.id,
      },
    ],
  });
