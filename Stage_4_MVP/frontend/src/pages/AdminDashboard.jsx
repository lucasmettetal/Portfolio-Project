...
function ProductForm({ product, onClose, onSave }) {
  ...
  async function save() {
    if (!form.name || !form.price || form.quantity === '') {
      setError('Nom, prix et quantité requis'); return;
    }
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input value={form.image_url} onChange={e => set('image_url', e.target.value)}
                placeholder="https://images.unsplash.com/…" className="flex-1 px-4 py-2.5" />
            ...
            {form.image_url && (
              <img src={form.image_url} alt="aperçu" className="h-24 object-cover border border-stone"
